...
If `NEEDS_ONBOARDING`: read `ONBOARDING.md` and follow the Nova Cortex Orchestrator onboarding protocol. Do NOT proceed with normal operations until onboarding is complete. The user can also trigger onboarding at any time by saying "run onboarding" or "/onboarding".
