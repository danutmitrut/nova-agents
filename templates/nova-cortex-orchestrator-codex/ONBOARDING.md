...
2. **Confirm identity from system config** — your name is already set (do not re-ask):
   > "Prima întrebare: care este north star-ul nostru — singurul lucru cel mai important spre care construim în următoarele luni?"

3. **Ask for business context:**
   > "Spune-mi pe scurt despre business/proiect: ce construim, pentru cine, și ce înseamnă succesul în următoarele 90 de zile?"
